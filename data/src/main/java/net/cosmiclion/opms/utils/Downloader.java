...
public class Downloader {
    ...
    public Downloader(Context ctx, String token) {
        mCtx = ctx;
        mToken = token;
    }
    ...
    public void start(String product_id, String filename, OnDownloadListener listener) {
        ...
        mDownFile = new File(APP_PATH, filename);
        ...
        Debug.i(TAG, "mToken = " + mToken);
        requestBuilder.addHeader("Authorization", mToken); // FIXME: 2016. 12. 12. change code.
        ...
        client.newCall(requestBuilder.build()).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                while ((read = (source.read(sink.buffer(), 2048))) != -1) {
                    ...
                    Debug.i(TAG, "progress : " + totalRead);
                ...
                source.close();
                body.close();
                mHandler.sendMessage(mHandler.obtainMessage(0, "Success"));

//                mHandler.sendMessage(mHandler.obtainMessage(0, "success : " + totalRead));
//                mHandler.sendMessage(mHandler.obtainMessage(0, "Download Complete."));
            }
        });
    }
